...
| 名称 | 数量 | 重复 | 重合度 |
| ---- | ---- | ---- | ------ |
|  [BlackList](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/QuantumultX/BlackList)    | 778   | [1](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Repeat/Cloudflare/BlackList.list)   |   0.13%  |
|  [Proxy](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/QuantumultX/Proxy)    | 5984   | [1](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Repeat/Cloudflare/Proxy.list)   |   0.02%  |
## 配置说明
...
本项目的Cloudflare分流规则的数据来自以下链接，通常已涵盖所有数据来源的分流规则。如果你正在使用这些分流规则，请先删除后再使用本项目的Cloudflare分流规则，以免造成规则重复。
